...
const actualizeTeacher = async (req, res = Response) => {
    try {
        console.log(req.body);
       const {id, name, fechaNacimiento,domicilio,municipio, telefono,contactoEmergencia,email,role,clabe,cuenta,banco,comprobante,fecha_inicio, maestroInstrumentos, user_id, empleado} = req.body;
       await insertLog({empleado, accion:'Maestro modificado'});
